...
class CamNodeRight(Node):
    def __init__(self):
        super().__init__('cam_node_right')
        self.publisher_ = self.create_publisher(Image, 'right_camera/image_raw', 10)
        self.bridge = CvBridge()
        self.cap = cv2.VideoCapture(2)  # Right camera (usually index 1)
