...
class CamNodeRight(Node):
    def __init__(self):
        super().__init__('cam_node_back')
        self.publisher_ = self.create_publisher(Image, 'back_camera/image_raw', 10)
        self.bridge = CvBridge()
        self.cap = cv2.VideoCapture(8)  # Right camera (usually index 1)
